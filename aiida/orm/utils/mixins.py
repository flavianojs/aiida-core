...
class Sealable:
    ...
    @override
    def put_object_from_filelike(self, handle: io.BufferedReader, path: str, mode='w', encoding='utf8'):  # pylint: disable=unused-argument
        ...
        """
        if self.is_sealed:
            raise exceptions.ModificationNotAllowed('the repository of a sealed node is immutable.')
